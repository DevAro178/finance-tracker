                ...
                <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                  <div class="card card-plain">
                    ...
                    <form method="POST" action="{{route('add.category.store')}}">
                        ...
                        <div class="mb-3">
                          <input type="number" class="form-control form-control-lg" name="amount" placeholder="Budget" aria-label="Budget" value="{{old('amount')}}">
                          @error('amount')
                                  <span class="text-danger text-xs mt-1">{{$message}}</span>
                          @enderror
                        </div>
                        <div class="text-center">
                          <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Add Category</button>
                        </div>
                      </form>
                    </div>
                  </div>
