                        ...
                        <div class="d-flex">
                          <div class="d-flex">
                            ...
                            <div>
                              ...
                              <h6 class="text-white mb-0">{{date('m/y', strtotime('+5 year'));}}</h6>
                            </div>
                          </div>
            ...
            <div class="col-md-6 mt-4">
              <div class="card h-100">
                ...
                <div class="card-body p-3 pb-0">
                  <ul class="list-group">
                    <div class="d-flex justify-content-center"><p class="text-xs font-weight-bold mb-0">No Invoices Yet.</p></div>
                    {{-- <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                      <div class="d-flex flex-column">
