                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Spent</p>
                                        <h5 class="font-weight-bolder">
                                            {{ $spent }}
                                        </h5>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Remaining</p>
                                        <h5 class="font-weight-bolder">
                                            {{ $remaining }}
                                        </h5>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Savings</p>
                                        <h5 class="font-weight-bolder">
                                            {{ $savings }}
                                        </h5>
                                    </div>
                                                ...
                                                <div class="d-flex px-2 py-1 align-items-center">
                                                    <div>
                                                        <img src="{{ $account->icon ? asset('storage/' . $account->icon) : asset('/storage/icons/no-image.png') }}"
                                                            alt="icon" class="img-fluid me-3" width="25px">
                                                    </div>
                                                    <div class="ms-4">
                                                        <p class="text-xs font-weight-bold mb-0">Acc Name:</p>
                                                        <h6 class="text-sm mb-0">{{ $account->name }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <h6 class="text-sm mb-0">{{ $account->type }}</h6>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Balance:</p>
                                                    <h6 class="text-sm mb-0">{{ number_format($account->balance, 2) }}
                                                    </h6>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <li
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="text-xs">Budget assigned: <span
                                                        class="font-weight-bold">{{ number_format($category->amount, 2) }}</span></span>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                            <button
