                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    @if (isset($topup))
                                        <form method="POST" action="{{ route('topup.transaction.add') }}">
                                        @else
                                    ...
                                    <div class="mb-3">
                                        <input type="date" class="form-control form-control-lg" name="date"
                                            placeholder="date" aria-label="date" value="{{ old('date') }}">
                                        @error('date')
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Add
                                            Transaction</button>
                                    </div>
                                    </form>
                                </div>
